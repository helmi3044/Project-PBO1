...
# ada 2 method yang hampir sama dgn person (set atau memasukkan data)  
# method fungsinya hampir mirip dengan setdataperson
class Pembeli(Person):
	def setDataPembeli(self, Nama, Alamat, NomorHP):
		...
		IdPerson = self.getDataPerson(Nama, Alamat, NomorHP) #var idperson ambil dri get utk dimasukkan di pembeli
	...
	def getDaftarPembeli(self):
		self.query = 'SELECT t1.IdPembeli, t2.Nama, t2.Alamat, t2.NomorHP \
			FROM  Pembeli t1 \
